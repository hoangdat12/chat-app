  ...
  return (
    <>
      <div className='fixed top-6 right-6'>
        <Button
          text='Back to home'
          className='bg-blue-500 text-white px-6 py-2 border-none'
          textSize='text-2xl'
          onClick={() => navigate('/')}
        />
      </div>
      ...
      <div className='introduce more-about-me'>
        ...
        <p>
          My favorite hobby was playing football. But now I am enjoying most of
          my time with study coding!
        </p>
        <h2>What's your dream job?</h2>
        <p>
          My goal is that become a full stack developer, so that I can manage
          front-end side and back-end side as well. Before achieve that goal, I
          need to master back-end developer skills first!
        </p>
      </div>
